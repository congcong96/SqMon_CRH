...
if ( ~isempty(findstr(soundtype, 'dmr')) ) % if the stimulus is dmr
   sigma2 = (mdb)^2 / 8; % variance of dynamic moving ripple
else
   sigma2 = (mdb)^2 / 12; % variance of ripple noise
end
...
%based on number of spikes, but what does this exactly mean??!!!
